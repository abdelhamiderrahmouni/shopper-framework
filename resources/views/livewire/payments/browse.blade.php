<div>
    <x-shopper::heading>
        <x-slot name="title">
            {{ __('shopper::layout.sidebar.payments') }}
        </x-slot>
    </x-shopper::heading>

    @if($total === 0)
        <x-shopper::empty-state
            :title="__('shopper::pages/payments.title')"
            :content="__('shopper::pages/payments.content')"
        >
            <div class="shrink-0">
    ...
    @else
        <div class="mt-6">
            <livewire:shopper-tables.payments-table />
        </div>
    @endif
